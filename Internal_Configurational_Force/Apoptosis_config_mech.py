...
def setup_problem(Lx, Ly, Nx, Ny, beta, ebar, alpha, k1, k2, gamma, tau, dealias, dtype):
    import numpy as np
    ...
    problem.add_equation("r = - (k1/np.pi) * np.arctan((k2 * sig))")
...
def main(beta, ebar, alpha, k1, k2, gamma, tau):
    import numpy as np
    Lx, Ly = 4.0, 4.0
    Nx, Ny = 512, 512
    ...
    problem, dist, xbasis, ybasis, phi, ep, ep_prime, sig, r, theta, f, x, y = setup_problem(Lx, Ly, Nx, Ny, beta, ebar, alpha, k1, k2, gamma, tau, dealias, dtype)
    initialize_fields(x, y, Lx, Ly, Nx, Ny, phi, ep, ep_prime, sig, r, theta, beta, ebar, alpha, k1, k2, gamma, tau)
...
if __name__ == "__main__":
    ...
    parser.add_argument('k1', type=float, help='Parameter k1')
    ...
    main(args.beta, args.ebar, args.alpha, args.k1, args.k2, args.gamma, args.tau)